...
const Form = () => {
    ...
    return (
        <form onSubmit={formik.handleSubmit} style={{ maxWidth: '500px', margin: 'auto' }}>
            ...
            <div className="form-group" style={{ marginBottom: '15px' }}>
                <label htmlFor="contact_no" style={{ display: 'block', marginBottom: '5px' }}>Contact Number:</label>
                <input
                    type="text"
                    id="contact_no"
                    name="contact_no"
                ...
                {formik.touched.contact_no && formik.errors.contact_no ? (
                    <div className="error" style={{ color: 'red' }}>{formik.errors.contact_no}</div>
                ) : null}
            </div>
            ...
            <div className="form-group" style={{ marginBottom: '15px' }}>
                <label htmlFor="confirm_password" style={{ display: 'block', marginBottom: '5px' }}>Confirm Password:</label>
                <input
                    type="password"
                    id="confirm_password"
                ...
                {formik.touched.confirm_password && formik.errors.confirm_password ? (
                    <div className="error" style={{ color: 'red' }}>{formik.errors.confirm_password}</div>
                ) : null}
            </div>

            <button
                type="submit"
                style={{ backgroundColor: 'blueviolet', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '5px', cursor: 'pointer' }}
            >
                Submit
            </button>
        </form>
